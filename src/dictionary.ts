...
const MESSAGES = {
  ...
  TARGET_IS_BOT: random([
    'А ты не прихуел?',
    'Я с тебя админку сниму нахуй',
    'Меня можно убить только глупым багом, команды тут бессильны',
  ]),
  DOTNET: {
    NO_USERNAME_MENTION: {
      DEFAULT: random([
      ...
      BLACKLISTED: random([
        ...
        'Чмо дырявое',
        'Говноед',
        'ебаный рыцарь с пиздаком своей мамаши как с щитом на плече от моего хуя',
      ]),
    },
    MESSAGE_BLOCKED: {
      DOT: {
      ...
      UNICODE: {
        DEFAULT: gradient(Time.Minutes_30, [
          ...
          '{{mention}}, возьми и ебанись об клаву',
        ]),
        BLACKLISTED: gradient(Time.Minutes_30, [
          '{{mention}}, может уже ливнешь просто? Пытается он тут',
          '{{mention}}, просто ливни, никто тебя не будет больше обижать',
          '{{mention}}, ты @Izbushka?',
          '{{mention}}, мой хуй не карандаш, но он оставил автограф на губе твоей мамаши',
        ]),
      },
    },
